                  ...
                  <div className="mt-auto flex items-center justify-between pt-2">
                    <div className="flex items-center rounded-lg border border-neutral-200">
                      <button
                        ...
                        className="px-2.5 py-1.5 text-neutral-500 transition hover:text-neutral-950 disabled:opacity-40"
                        aria-label="Decrease quantity"
                      >
                        <Minus className="h-3.5 w-3.5" />
                      </button>
                      <span className="min-w-8 text-center text-xs font-semibold text-neutral-950">
                        {item.quantity}
                      </span>
                      <button
                        type="button"
