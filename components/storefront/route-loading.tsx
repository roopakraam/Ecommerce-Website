...
export function StorefrontRouteLoading({
  ...
  if (variant === "grid") {
    return (
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mb-8 h-20 animate-pulse rounded-xl bg-neutral-100" />
  ...
  if (variant === "detail") {
    return (
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="mb-8 h-4 w-48 animate-pulse rounded bg-neutral-100" />
  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-16 sm:px-6">
      ...
      <div className="mt-4 h-64 w-full animate-pulse rounded-2xl bg-neutral-100" />
    </main>
  );
}
